...
import com.adonayg.services.ProductService;
...
public class ProductControllerTest {
    ...
    //Suppress warnings on (list) casting of products to strip generics. Can be removed.
    ...
    public void testList() throws Exception{
       ...
       //need to strip generic by casting products as interface List, otherwise Mokito won't work
